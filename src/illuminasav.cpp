    ...
    for (size_t lane = 0; lane < summary_index.size(); ++lane) {
        ...
        for (size_t index = 0; index < index_lane_sum.size(); ++index) {
            ...
            if (samples.count(sample_id) == 0) {
                Sample sample(index_count_sum.id(), index_count_sum.index1(),
                              index_count_sum.index2(),
                              index_count_sum.fraction_mapped(),
                              index_count_sum.cluster_count(),
                              index_count_sum.sample_id(),
